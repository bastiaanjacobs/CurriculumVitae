...
gulp.task(
  "serve",
  ["fonts", "images", "js", "scss", "components", "images"],
  function() {
    browserSync.init({
      server: {
        baseDir: "./",
...
gulp.task("scss", function() {
  return gulp
    .src(SCSS_SRC) //reads all the SASS files
...
gulp.task("images", function() {
  return gulp.src(imageFiles).pipe(gulp.dest("./dist/img"));
});
gulp.task("js", function() {
  return gulp.src(jsFiles).pipe(gulp.dest("./dist/js"));
});
gulp.task("fonts", function() {
  return gulp.src(fontFiles).pipe(gulp.dest("./dist/fonts"));
});
